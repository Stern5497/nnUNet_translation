...
class nnUNetTrainerMRCT_AFP_TSCompact(nnUNetTrainer):
    """
    nnUNet trainer using AFP loss with TS_Compact7_3x1x1 feature extractor.
    
    This trainer uses the compact 7-class TotalSegmentator model adapted for 3x1x1 mm resolution.
    The model groups anatomical structures into: organs, cardiac, muscles, bones, ribs, and vertebrae.
    
    Usage:
        nnUNetv2_train DatasetY 3d_fullres 0 -tr nnUNetTrainerMRCT_AFP_TSCompact -pl nnResUNetPlans
    """
    def __init__(
        self,
        plans: dict,
        ...
        self.batch_size = 1
        # Use the new TS_Compact7_3x1x1 model for AFP loss
